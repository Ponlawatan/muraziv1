...
class BusinessCatalogPage extends StatefulWidget {
  const BusinessCatalogPage({super.key});

  @override
  _BusinessCatalogPageState createState() => _BusinessCatalogPageState();
}
...
class _BusinessCatalogPageState extends State<BusinessCatalogPage> {
  ...
  Future<void> _loadPlaces() async {
    try {
      ...
      final places = await _placeService.getPlacesByCategory('การงาน');
      setState(() {
        _places = places;
        _isLoading = false;
      });
  ...
  Future<void> _loadFilteredPlaces() async {
    try {
      ...
      if (_selectedProvince == null || _selectedProvince == 'ทั้งหมด') {
        filteredPlaces = await _placeService.getPlacesByCategory('การงาน');
      } else {
        final allPlaces = await _placeService.getPlacesByCategory('การงาน');
